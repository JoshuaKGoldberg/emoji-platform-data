...
- `generateDiscord()`, `generateEmojiMart()`, `generateEmojipedia()`, `generateFluemoji()`, `generateGemoji()`, `generateMacOS()`, `generateTwemoji()`, `generateWeChat()`: generate data for a single platform
