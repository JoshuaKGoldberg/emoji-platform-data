...
- `generateDiscord()`, `generateEmojiMart()`, `generateEmojipedia()`, `generateFluemoji()`, `generateGemoji()`, `generateMacOS()`, `generateSlack()`, `generateTwemoji()`, `generateWeChat()`: generate data for a single platform
