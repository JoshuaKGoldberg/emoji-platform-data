...
Unlike the other packages in this repository, this data has no upstream project to install.
...
Each snapshot records the macOS version it came from, and is refreshed per macOS release rather than tracking an upstream package.
