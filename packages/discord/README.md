...
1,557 of the 1,932 emoji have them, averaging 6.15 each; the 375 without are almost all country flags, which the picker finds by name alone.
...
The shortcodes and the keywords live in two different scripts there, and the keywords are one set per locale; these are the `en-US` ones.
